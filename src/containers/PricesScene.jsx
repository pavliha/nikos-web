...
const PricesScene = ({ classes }) =>
  <div className={classes.root}>
    ...
    <section id="WeddingPhotoVideo">
      <Typography variant="h4" className={classes.headline}>Всё вместе: фотосъемка и видеосъемка свадьбы</Typography>
      <main className={classes.services}>
        <section className={classes.service}>
          ...
          <List>
            ...
            <CheckListItem>Индивидуально оформленный комплект дисков (видео в формате Full HD +
              фото)</CheckListItem>
    ...
    <section id="WeddingPhoto">
      <Typography variant="h4" className={classes.headline}>Фотосьемка свадьбы</Typography>
      <main className={classes.services}>
        <section className={classes.service}>
          <Typography className={classes.title} variant="h5">
            Пакет<br /> «<span className={classes.budgetColor}>Эконом</span>»
    ...
    <section id="WeddingVideo">
      <Typography variant="h4" className={classes.headline}>Видеосьемка свадьбы</Typography>
      <main className={classes.services}>
        <section className={classes.service}>
          <Typography className={classes.title} variant="h5">
            Пакет<br /> «<span className={classes.budgetColor}>Эконом</span>»
    ...
    <section id="CelebrationPhoto">
      <Typography variant="h4" className={classes.headline}>Фотосьёмка и видеосьёмка праздников</Typography>
      <main className={classes.services}>
        <section className={classes.service}>
          <Typography className={classes.title} variant="h5">Фотосьёмка</Typography>
          <List>
        ...
        <section className={classes.service}>
          <Typography className={classes.title} variant="h5">Видеосьёмка</Typography>
          <List>
        ...
        <section className={classes.service}>
          <Typography className={classes.title} variant="h5">Все вместе</Typography>
          <List>
            <CheckListItem>Работа фотографа</CheckListItem>
            <CheckListItem>Работа видеооператора</CheckListItem>
            <CheckListItem>Обработка не менее 50 фотографий</CheckListItem>
